...
3. **Create Pull Request:** After the testing period, create a Pull Request from the `stable-YYYY-MM` branch into the `main` branch of the `ha-addons` (stable) repository. !!! HOW TO SOLVE DIFFERENT README.MD FILES???
