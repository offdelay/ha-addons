...
*Note: Only perform this step once the Edge versions have been verified as stable.*

1. **Copy from Edge to Stable:** Move the verified addon folders from the Edge repository to the Stable repository.
2. **Push Changes:** Commit and push to the `ha-addons` repository.